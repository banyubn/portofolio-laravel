...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/icons/letter_b.png') }}" type="image/x-icon" />
...
<body>
    <div class="d-flex justify-content-center mt-3">
        <nav class="rounded-pill shadow d-flex justify-content-center gap-5 align-items-center">
